...
urlpatterns = [
    ...
    path('output-verification/', views.OutputVerificationReportView.as_view(), name='verification'),
    path('indicator-achievements/', views.IndicatorAchievementReportView.as_view(), name='indicators'),
